...
function ProfileMenu() {
  ...
  return (
    <div
      role="menu"
      tabIndex="0"
      className="account-drop-down absolute sub-menu top-12 right-14 "
      style={{ opacity: "1", transitionDuration: "1s" }}
    >
      <div className="top-div bg-transparent w-full h-4"></div>
      <div className="py-4 px-1 bg-[#050606]">
        <ul
          className="sub-menu-list profiles flex flex-col gap-3 mb-4"
          role="list"
          aria-label="Profiles"
        >
          <li className="sub-menu-item profile" role="listitem">
            <div>
              <a
                ...
                tabIndex="0"
                href="/SwitchProfile?tkn=5K4E6TAFKFC7ZCSWHFGZLJOXLM"
                data-uia="action-select-profile+primary"
              >
                <div className="avatar-wrapper ">
                  <img
                    className="profile-icon rounded me-3"
                    src="https://occ-0-7777-3663.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABXYofKdCJceEP7pdxcEZ9wt80GsxEyXIbnG_QM8znksNz3JexvRbDLr0_AcNKr2SJtT-MLr1eCOA-e7xlDHsx4Jmmsi5HL8.png?r=1d4"
                    alt=""
                  />
                </div>
                <span className="profile-name">Jhon</span>
              </a>
          ...
          <li className="sub-menu-item profile" role="listitem">
            <div>
              <a
                className="profile-link"
                tabIndex="0"
                href="/SwitchProfile?tkn=2V7LMG562BGWVBBYASSN5S2CSE"
                data-uia="action-select-profile+kids"
              >
                <div className="avatar-wrapper">
                  <img
                    className="profile-icon rounded me-3"
                    src="https://occ-0-7777-3663.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABYh1GXyzHI-IqH5gUm3DHnqwmPCTLO5rmui76NzrDHgzMA7or4fZQUjLBsrXzx0JiwagUlQSf7Wiu4yI-A4hfpwleGn8R3g.png?r=54d"
                    alt=""
                  />
                </div>
                <span className="profile-name">Children</span>
              </a>
              <div className="profile-children"></div>
            </div>
          </li>
        ...
        <ul
          className="account-links sub-menu-list flex flex-col gap-3 mb-2"
          aria-label="Account"
        >
          ...
          <li className="sub-menu-item">
            <a
              className="sub-menu-link sub-menu-link-icon"
              href="/account/profile/transfer/XEIN5TRXXZDC3EMJBTL3JVXSCY"
            >
              <svg
                id="profile-transfer"
                width="24"
          ...
          <li className="sub-menu-item">
            <a className="sub-menu-link sub-menu-link-icon" href="/account">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                role="img"
      ...
      <ul className="sub-menu-list sign-out-links border-t border-gray-400 bg-[#050606]">
        <li className="sub-menu-item">
          <a className="sub-menu-link p-4 px-10" href=""
          onClick={logout}>
            Sign out of Netflix
          </a>
        </li>
