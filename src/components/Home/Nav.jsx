...
function Nav() {
  ...
  return (
    <nav
      className={`nav-container regular-text flex items-center  ${
        scrolled ? "nav-scrolled" : ""
      }`}
    >
      <a className="logo-icon" href="/"></a>
      <ul>
        <li>
        ...
        <li>
          <Link to="shows">New & Popular</Link>
        </li>
        <li>
          <Link to="shows">My List</Link>
        </li>
        <li>
          <Link to="shows">Browse by Languages</Link>
        </li>
      </ul>
